    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {areas.map((area, i) => (
            <motion.div key={area} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }} className="flex items-center gap-2 bg-white rounded-full px-5 py-3 border border-gray-200 shadow-sm hover:shadow-md hover:border-primary-light/30 transition-all">
